      ...
      <div className="main-content w-full pt-12">
        <center>
          ...
          <div className="flex justify-center space-x-4 font-mono text-white text-sm font-bold leading-6 bg-stripes-fuchsia rounded-lg">
            <div className="justify-self-auto p-4 rounded-lg bg-blue-500 shadow-lg">
              MacOS
            </div>
            <div className="justify-self-auto p-4 rounded-lg bg-blue-500 shadow-lg">
              Linux
          ...
          <div className="inline-block p-4 shadow-sm bg-blue-500 w-16 h-16 rounded-full">
            <p className="font-semibold text-xl sm:text-2xl md:text-3xl lg:text-4xl pb-2 text-center">
              {" "}
              1{" "}
            </p>
          </div>
          ...
          <div>
            Open the downloaded folder and navigate to scripts folder then open
            the MacOS-whatsapp.sh file. This will start the proxy in Terminal.
          </div>

          <div className="inline-block p-4 shadow-sm bg-blue-500 w-16 h-16 rounded-full">
            <p className="font-semibold text-xl sm:text-2xl md:text-3xl lg:text-4xl pb-2 text-center justify-space-between">
              {" "}
              3{" "}
            </p>
          </div>
          ...
          <div>
            That’s it, you now have a working proxy! Share the address displayed
            at the bottom of the Terminal to allow others to connect to your
            proxy. Please consider registering your proxy on our list to help
            people find it.
          </div>
