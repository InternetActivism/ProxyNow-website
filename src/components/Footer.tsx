const Footer = (props) => {
  if (props.light) {
    return (
      <>
        <div className="flex flow-root justify-between footer relative p-3 bg-white text-[#0085FF]">
          ...
          <div className="float-right inset-y-0 right-0 items-end">
            <p className="text-[8px] sm:text-sm md:text-md lg:text-lg text-[#0085FF]">
