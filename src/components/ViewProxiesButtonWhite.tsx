const ViewProxiesButtonWhite = () => {
    return(
        <>
        <button className="group proxy-button ml-5 inline-flex bg-[white] hover:bg-[#0085FF] hover:text-white text-[#0085FF] text-[24px] border border-[#0085FF] font-semibold py-2 pl-6 pr-2 rounded-full">
            View All Proxies
...
export default ViewProxiesButtonWhite;