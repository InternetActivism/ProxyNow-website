...
const ButtonFilter = (props) => {
    ...
    return(
        <>
        <button className={`flex proxy-button ${props.fill} ${props.hoverColor} ${props.textColor} ${props.hoverTextColor} ${props.selectedColor} ${props.selectedTextColor} py-2 rounded-xl w-28 sm:w-32 md:w-36 lg:w-44`}>
