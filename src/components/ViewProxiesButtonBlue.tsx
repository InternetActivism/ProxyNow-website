const ViewProxiesButtonBlue= () => {
    return(
        <>
        <button className="group proxy-button inline-flex items-center bg-[#0085FF] hover:bg-blue-700 hover:text-white text-[white] py-2 rounded-full">
...
export default ViewProxiesButtonBlue;